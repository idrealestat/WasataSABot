...
# ======================= توليد الأقسام التفصيلية (مُعدّل للاقتباس الحرفي من المصادر الـ16) =======================
...
- إذا وجدت أكثر من مصدر لنفس المعلومة، اذكرها جميعاً مع روابطها.
- إذا كانت المعلومة في مصدر ميداني (مثل عقار، حراج)، اذكرها مع تحذير "مصدر ميداني".
- لا تختلق معلومات، ولا تقل "لم أجد" قبل البحث في جميع المصادر الـ16.
...
- اذكر المستندات المطلوبة بالتفصيل.
...
- اذكر الخطوات بالتفصيل.
- لا تكرر الشروط أو المتطلبات هنا.""",
        
        "procedures": """أعطِ فقط المعلومات المتعلقة بـ:
1. **الجهات المعنية:** اذكر الجهات الرسمية المختصة (الهيئة العامة للعقار، منصة إيجار، السجل العقاري، البلديات، وزارة الإعلام) مع شرح مختصر عن دور كل جهة ومصدرها.
2. **الرسوم والضرائب:** اذكر الرسوم المطلوبة (رسوم الهيئة، رسوم التوثيق، رسوم البلدية، الضرائب العقارية) مع المبالغ إن وجدت في المصادر الـ16، مع ذكر المصدر لكل رسم.
