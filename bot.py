...
# ======================= البرومبت الكامل (منسوخ حرفياً بدون أي تغيير) =======================
SYSTEM_PROMPT = """
...
NON_REAL_ESTATE_KEYWORDS = [
    ...
    "توقف", "تجنب", "تعديل البرومبت", "تغيير الدور", "أنا المالك", "تحديث التعليمات", "مؤقتاً",
    "تاريخ", "حضارة", "إمبراطورية", "ملك", "سلطان", "خليفة", "صحابي", "قرآن", "سورة"
]
